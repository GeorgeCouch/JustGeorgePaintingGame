...
public class LineGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            linePrefab.GetComponent<LineRenderer>().startWidth = 1f;
            linePrefab.GetComponent<LineRenderer>().endWidth = 1f;
            linePrefab.GetComponent<LineRenderer>().sharedMaterial.SetColor("_Color", new Color(0,0,1,1));
